...
export default class DoctorRegister extends Component{
    ...
    {
        super()
        this.state={doctor_Name:'',doctor_DOB:'',doctor_Gender:'',doctor_Mobile_number:'',doctor_Email:'',doctor_Username:'',doctor_Password:'',doctor_License_Number:'',doctor_Fees:'',doctor_Experience:'',
								...
								<div className="row align-items-center justify-content-center">
									...
									<div className="col-md-12 col-lg-6 login-right">
										...
										<form action="/login">
											...
											<div className="form-group form-focus">
												<input type="date" className="form-control floating" name='doctor_DOB' onBlur={(e)=>{this.setState({doctor_DOB:e.target.value})}}/>
											...
											<input type="radio" name="doctor_Gender" value="female" onBlur={(e)=>{this.setState({doctor_Gender:e.target.value})}}/>&nbsp;Female &nbsp; &nbsp;
											 <input type="radio" name="doctor_Gender" value="male" onBlur={(e)=>{this.setState({doctor_Gender:e.target.value})}}/>&nbsp;Male
											</div>
											...
											<div className="form-group form-focus">
											<label className="focus-label">Hospital</label>
											...
											<button className="btn btn-primary btn-block btn-lg login-btn" type="submit" onClick={this.sendDoctor}>Register</button>
